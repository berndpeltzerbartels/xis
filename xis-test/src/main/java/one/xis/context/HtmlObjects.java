...
class HtmlObjects {
    ...
    private void init() {
        ...
        this.window = new Window(document.getLocation(), document, localStorage, sessionStorage, console);
        if (document instanceof one.xis.test.dom.DocumentImpl documentImpl) {
            documentImpl.setDefaultView(window);
        }
    }
}
