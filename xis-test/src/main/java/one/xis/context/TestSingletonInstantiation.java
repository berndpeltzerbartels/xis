...
class TestSingletonInstantiation extends SingletonInstantiation {
    ...
    TestSingletonInstantiation(FieldInjection fieldInjection, InitMethodInvocation initMethodInvocation, Reflection reflections, Collection<Object> mocks, Collection<Class<?>> classes) {
