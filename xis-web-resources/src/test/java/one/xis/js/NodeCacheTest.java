...
class NodeCacheTest {
    ...
    void sizeUp() throws ScriptException {
        ...
        js += "var cache = new NodeCache(nodeArray); cache.sizeUp(3); [cache.getChildren(0), cache.getChildren(1), cache.getChildren(2)]";
        Map<String, Object> bindings = Map.of("nodeArray", new Node[]{new Element("a"), new Element("b")});
