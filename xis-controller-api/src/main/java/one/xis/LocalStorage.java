...
/**
 * Binds a value from the browser's localStorage to an action method parameter or method return value.
 *
 ...
 * localStorage after method execution.
 ...
 * parameter value, removes the value from localStorage.</p>
 *
