...
public abstract class XISGroovyTemplateTask extends GroovyCompile {
    ...
    public XISGroovyTemplateTask() {
        getDestinationDirectory().set(getProject().getLayout().getBuildDirectory().dir("tmp/xis-groovy-templates-classes"));
