...
class UpdateEventTest {
    ...
    void actionFromWidget1TriggersWidget2Reload() {
        ...
        assertThat(client.getDocument().getElementById("widget1-load-count").getInnerText()).isEqualTo("1");
        assertThat(client.getDocument().getElementById("widget2-load-count").getInnerText()).isEqualTo("1");

        // Click action in Widget1 - should emit "widget2-update" event
        client.getDocument().getElementById("widget1-action-link").click();
        ...
        assertThat(client.getDocument().getElementById("widget2-load-count").getInnerText()).isEqualTo("2");
    }
