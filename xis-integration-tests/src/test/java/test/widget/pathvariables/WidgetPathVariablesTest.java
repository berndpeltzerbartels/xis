...
class WidgetPathVariablesTest {
    ...
    void widgetsLoadInCorrectContainersBasedOnAnnotation() {
        ...
        var widget1Category = client.getDocument().getElementById("widget1-category");
        ...
        var widget1Data = client.getDocument().getElementById("widget1-data");
        ...
        var widget2Category = client.getDocument().getElementById("widget2-category");
        assertThat(widget2Category).isNotNull();
        assertThat(widget2Category.getTextContent()).isEqualTo("electronics");

        var widget2Data = client.getDocument().getElementById("widget2-data");
