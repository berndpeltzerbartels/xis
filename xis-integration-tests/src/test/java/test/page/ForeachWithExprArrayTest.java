...
class ForeachWithExprArrayTest {
    ...
    @Test
    void test() {
        testContext.openPage(ForeachWithExprArray.class);

        var div1 = testContext.getDocument().getElementById("list1");
        var div2 = testContext.getDocument().getElementById("list2");
