...
class IfConditionTest {
    ...
    void testConditions() {
        ...
        // 6. <div id="condition-negated-boolean" xis:if="${!canUndo}">
        Element negatedBoolean = client.getDocument().getElementById("condition-negated-boolean");
        assertThat(negatedBoolean).isNotNull();
        assertThat(negatedBoolean.getInnerText()).isEqualTo("True with negated boolean in attribute style");
    }
}
