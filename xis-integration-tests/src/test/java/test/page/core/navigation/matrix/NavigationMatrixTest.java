...
class NavigationMatrixTest {
    ...
    @Test
    void pageActionCanChangeFrontletWithFrontletUrlResponse() {
        var client = context.openPage("/navigation/core.html?mode=keep");

        client.getDocument().getElementById("page-frontlet-url-response").click();
    ...
    @Test
    void frontletActionCanChangeFrontletWithFrontletUrlResponse() {
        var client = context.openPage("/navigation/core.html?mode=keep");

        client.getDocument().getElementById("frontlet-url-response").click();
    ...
    @Test
    void voidFrontletActionKeepsPagePathQueryAndParameters() {
        var client = context.openPage("/navigation/core.html?mode=keep");
