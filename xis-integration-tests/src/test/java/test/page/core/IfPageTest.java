...
class IfPageTest {
    ...
    void testCondition1True() {
        ...
        var client = testContext.openPage(IfPage.class);

        // Verify that the element for condition1 is rendered
        assertThat(client.getDocument().getElementByTagName("body").getInnerText()).contains("text1");
    }
    ...
    void testCondition1False() {
        ...
        assertThat(client.getDocument().getElementByTagName("body").getInnerText()).doesNotContain("text1");
    }
    ...
    void testCondition2True() {
        ...
        assertThat(client.getDocument().getElementByTagName("body").getInnerText()).contains("text2");
    }
    ...
    void testCondition2False() {
        ...
        assertThat(client.getDocument().getElementByTagName("body").getInnerText()).doesNotContain("text2");
    }
    ...
    void testSwitchCondition1() {
        ...
        client.getDocument().getElementById("link1").click();
    ...
    void testSwitchCondition2() {
        ...
        // Trigger the action to switch condition1
        client.getDocument().getElementById("link2").click();
