...
class IncompatibleParameterPageTest {
    ...
    class EmptyFormTest {
        ...
        void test() {
            ...
            assertThat(integerFieldMandatoryStyledLabel(document).getAttribute("style")).contains("color: red");
            assertThat(integerFieldMandatoryStyledLabel(document).getAttribute("style")).contains("font-weight: bold");
    ...
    class ErrorClassRemovalTest {
        ...
        void test() {
            ...
            // Verify error state is removed after value change
            assertThat(integerFieldMandatory(document).getAttribute("class")).isEmpty();
            assertThat(integerFieldMandatoryLabel(document).getAttribute("class")).doesNotContain("error");
            assertThat(integerFieldMandatoryStyledLabel(document).getAttribute("style")).isNullOrEmpty();
    ...
    private Element integerFieldMandatoryStyledLabel(Document document) {
        return document.getElementById("integerFieldMandatoryStyledLabel");
    }
