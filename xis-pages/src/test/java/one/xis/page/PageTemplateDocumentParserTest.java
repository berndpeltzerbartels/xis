...
// TODO
class PageTemplateDocumentParserTest {
    ...
    class SimpleElementTest {
        ...
        @BeforeEach
        void init() {
            var element = TemplateTestUtil.mockElement("div", Map.of("class", "gold"));
        ...
        @Test
        void parse() {
            var templateModel = new PageTemplateDocumentParser(new ExpressionParser()).parseTemplate(document, "123");

            TemplateElement element = (TemplateElement) templateModel.;
    ...
    class ElementWithControlsTest {
        private Document document;
        private final PageTemplateDocumentParser parser = new PageTemplateDocumentParser(new ExpressionParser());
        ...
        @Test
        void parse() {
            PageTemplateDocumentParser widgetTemplateModel = new PageTemplateDocumentParser(new ExpressionParser()).parseTemplate(document, "123");
    ...
    class ParseTemplate1 {
        ...
        private Document document;
        private final TemplateDocumentParser parser = new TemplateDocumentParser(new ExpressionParser());
