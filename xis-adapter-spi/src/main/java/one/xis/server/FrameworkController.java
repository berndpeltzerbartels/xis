...
public interface FrameworkController<RESP_WRAPPER, REQ, RESP> {
    ...
    RESP_WRAPPER getFrontletModel(ClientRequest request, String authenticationHeader, Locale locale);

    RESP_WRAPPER onPageLinkAction(ClientRequest request, String authenticationHeader, Locale locale);

    RESP_WRAPPER onFrontletLinkAction(ClientRequest request, String authenticationHeader, Locale locale);
