...
class WidgetJavascriptsTest {

    private WidgetJavascripts widgetJavascripts;
    ...
    void init() {
        ...
        TestContext testContext = TestContext.builder()//
                .withSingleton(WidgetJavascripts.class)//
    ...
    class GetActualWidget {
        ...
        @Test
        void getWidget() {
            WidgetJavascript widgetJavascript = widgetJavascripts.get("xyz");
