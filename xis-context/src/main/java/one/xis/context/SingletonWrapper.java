...
class SingletonWrapper implements SingletonConsumer, Finalizable {
    ...
    SingletonWrapper(Class<?> c, boolean additionalClass, AopProxyFactory aopProxyFactory) {
        beanClass = c;
        this.additionalClass = additionalClass;
        this.aopProxyFactory = aopProxyFactory;
    }

    SingletonWrapper(Class<?> c, AopProxyFactory aopProxyFactory) {
        this(c, false, aopProxyFactory);
    }

    SingletonWrapper(Object bean, boolean additionalClass, AopProxyFactory aopProxyFactory) {
        this.target = bean;
        this.bean = bean;
        this.additionalClass = additionalClass;
        this.aopProxyFactory = aopProxyFactory;
    ...
    public void assignValueIfMatching(Object o) {
        ...
        if (beanClass.isAssignableFrom(o.getClass())) {
            this.target = o;
            this.bean = aopProxyFactory.createProxyIfNeeded(o, o.getClass());
