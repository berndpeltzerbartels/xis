...
@Page("/login.html")
@HtmlFile("/login.html")
@DefaultHtmlFile("/default-login.html") // TODO  place file
class LocalLoginController implements Validator<IDPServerLogin> {
    ...
    @Action("login")
    public IDPServerLoginResponse login(@FormData("login") IDPServerLogin login) {
