...
| Parameter Annotation Reference | `xis/docs/content/reference/ParameterAnnotationReference.*` | `docs/user/annotations.md`, `docs/user/navigation.md` | covered | Current reference reflects `@ActionParameter`, `@FrontletParameter`, `@ModalParameter`, storage, `@ClientId`, `@UserId`, validation, formatter, and HTTP-controller parameters. |
