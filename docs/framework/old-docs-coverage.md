...
| XIS-Theme | `xis/docs/content/XisTheme.*` | `docs/user/advanced/theme.md` | covered | Dependency-only CSS loading, variables, logo override, navigation, grid, forms, and customization boundary are covered. |
