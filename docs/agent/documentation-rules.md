...
For custom JavaScript and integration-test behavior, remember that `xis-test` does not use a real browser. The browser
facade lives mainly in `xis-test/src/main/java/one/xis/test/dom`, `xis-test/src/main/java/one/xis/test/js`, and
`xis-test/src/main/java/one/xis/context/HtmlObjects.java`. Document supported browser-like globals in
`docs/user/advanced/integration-test-browser.md` and keep `docs/user/advanced/custom-javascript.md` linked to it.
