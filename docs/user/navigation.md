...
The frontlet receives the parameter with `@Parameter`.
...
The query parameters in the frontlet URL become frontlet parameters. The target frontlet reads them with `@Parameter`,
