...
Generated starter integration tests are Groovy tests below `src/test/groovy`. They use `@XisBootTest`, register the
Groovy page controller in the XIS test context, and use the test starter dependency that the XIS Gradle plugin adds
automatically.
