...
class JsonDeserializerTest {
    ...
    void deserialzeObject() throws IOException, NoSuchMethodException {
        ...
        var result = (A) deserializer.deserialze(json, TestPojo.class.getDeclaredMethod("test", A.class).getParameters()[0], ValidatorResultElement.rootResult());
    ...
    void deserialzeArray() throws IOException, NoSuchMethodException {
        var json = "[1,2,3,4]";
        var result = (List<Integer>) deserializer.deserialze(json, TestPojo.class.getDeclaredMethod("test1", List.class).getParameters()[0], ValidatorResultElement.rootResult());
    ...
    void typeParametersInTypeParameters() throws NoSuchMethodException, IOException {
        var json = "[[1],[2],[3],[4]]";
        var result = (List<List<Integer>>) deserializer.deserialze(json, TestPojo.class.getDeclaredMethod("test2", List.class).getParameters()[0], ValidatorResultElement.rootResult());
    ...
    void typeParametersInTypeParameters3() throws NoSuchMethodException, IOException {
        var json = "[[[1]]]";
        var result = deserializer.deserialze(json, TestPojo.class.getDeclaredMethod("test3", ArrayList.class).getParameters()[0], ValidatorResultElement.rootResult());
